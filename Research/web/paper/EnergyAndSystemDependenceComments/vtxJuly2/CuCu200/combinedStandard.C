void combinedStandard(bool write = false){
  gROOT->LoadMacro("VtxCutBin10dEtadPhi_trig_h_pT30_60_assoc_h_pT15_100_CentBin12DdEtaMethod.C");
  //TH1D *hn10CB1 = Cut10CB1(0.5,-0.2);
  //return;
  gROOT->LoadMacro("VtxCutBin14dEtadPhi_trig_h_pT30_60_assoc_h_pT15_100_CentBin12DdEtaMethod.C");
  gROOT->LoadMacro("VtxCutBin18dEtadPhi_trig_h_pT30_60_assoc_h_pT15_100_CentBin12DdEtaMethod.C");
  gROOT->LoadMacro("VtxCutBin22dEtadPhi_trig_h_pT30_60_assoc_h_pT15_100_CentBin12DdEtaMethod.C");
  gROOT->LoadMacro("VtxCutBin26dEtadPhi_trig_h_pT30_60_assoc_h_pT15_100_CentBin12DdEtaMethod.C");
  gROOT->LoadMacro("VtxCutBin2dEtadPhi_trig_h_pT30_60_assoc_h_pT15_100_CentBin12DdEtaMethod.C");
  gROOT->LoadMacro("VtxCutBin6dEtadPhi_trig_h_pT30_60_assoc_h_pT15_100_CentBin12DdEtaMethod.C");
  gROOT->LoadMacro("VtxCutBinn10dEtadPhi_trig_h_pT30_60_assoc_h_pT15_100_CentBin12DdEtaMethod.C");
  gROOT->LoadMacro("VtxCutBinn14dEtadPhi_trig_h_pT30_60_assoc_h_pT15_100_CentBin12DdEtaMethod.C");
  gROOT->LoadMacro("VtxCutBinn18dEtadPhi_trig_h_pT30_60_assoc_h_pT15_100_CentBin12DdEtaMethod.C");
  gROOT->LoadMacro("VtxCutBinn22dEtadPhi_trig_h_pT30_60_assoc_h_pT15_100_CentBin12DdEtaMethod.C");
  gROOT->LoadMacro("VtxCutBinn26dEtadPhi_trig_h_pT30_60_assoc_h_pT15_100_CentBin12DdEtaMethod.C");
  gROOT->LoadMacro("VtxCutBinn2dEtadPhi_trig_h_pT30_60_assoc_h_pT15_100_CentBin12DdEtaMethod.C");
  gROOT->LoadMacro("VtxCutBinn30dEtadPhi_trig_h_pT30_60_assoc_h_pT15_100_CentBin12DdEtaMethod.C");
  gROOT->LoadMacro("VtxCutBinn6dEtadPhi_trig_h_pT30_60_assoc_h_pT15_100_CentBin12DdEtaMethod.C");
...
//txtfiles/junkVtxCut10PtAssoc15Trig30To60CB1.txt:Number of trigger particles 189986
float ntrig10cb1 = 189986;
//txtfiles/junkVtxCut14PtAssoc15Trig30To60CB1.txt:Number of trigger particles 145506
float ntrig14cb1 = 145506;
//txtfiles/junkVtxCut18PtAssoc15Trig30To60CB1.txt:Number of trigger particles 151010
float ntrig18cb1 = 151010;
//txtfiles/junkVtxCut22PtAssoc15Trig30To60CB1.txt:Number of trigger particles 129994
float ntrig22cb1 = 129994;
//txtfiles/junkVtxCut26PtAssoc15Trig30To60CB1.txt:Number of trigger particles 112374
float ntrig26cb1 = 112374;
//txtfiles/junkVtxCut2PtAssoc15Trig30To60CB1.txt:Number of trigger particles 213307
float ntrig2cb1 = 213307;
//txtfiles/junkVtxCut6PtAssoc15Trig30To60CB1.txt:Number of trigger particles 165893
float ntrig6cb1 = 165893;
//txtfiles/junkVtxCutn10PtAssoc15Trig30To60CB1.txt:Number of trigger particles 201575
float ntrign10cb1 = 201575;
//txtfiles/junkVtxCutn14PtAssoc15Trig30To60CB1.txt:Number of trigger particles 186418
float ntrign14cb1 = 186418;
//txtfiles/junkVtxCutn18PtAssoc15Trig30To60CB1.txt:Number of trigger particles 167414
float ntrign18cb1 = 167414;
//txtfiles/junkVtxCutn22PtAssoc15Trig30To60CB1.txt:Number of trigger particles 146942
float ntrign22cb1 = 146942;
//txtfiles/junkVtxCutn26PtAssoc15Trig30To60CB1.txt:Number of trigger particles 125600
float ntrign26cb1 = 125600;
//txtfiles/junkVtxCutn2PtAssoc15Trig30To60CB1.txt:Number of trigger particles 216429
float ntrign2cb1 = 216429;
//txtfiles/junkVtxCutn30PtAssoc15Trig30To60CB1.txt:Number of trigger particles 107148
float ntrign30cb1 = 107148;
//txtfiles/junkVtxCutn6PtAssoc15Trig30To60CB1.txt:Number of trigger particles 211764
float ntrign6cb1 = 211764;
 ...
 float totaln2to2,total2to6,total6to14,total14to22,total22to30,totaln22to30,totaln14to22,totaln6to14,totaln2to6;
   ...
   totaln2to2 =ntrign2cb1;
   total2to6 =ntrig2cb1;
   total6to14 =ntrig6cb1+ntrig10cb1;
   total14to22 =ntrig14cb1+ntrig18cb1;
   total22to30 =ntrig22cb1+ntrig26cb1;
   totaln22to30 =ntrign30cb1+ntrign26cb1;
   totaln14to22 =ntrign22cb1+ntrign18cb1;
   totaln6to14 =ntrign14cb1+ntrign10cb1;
   totaln2to6 =ntrign6cb1;
 ...
 TH1D *lowz;
lowz = (TH1D*)hn2CB1->Clone("lowz");
   lowz->Scale(ntrign2cb1/totalLowz);
 ...
 TH1D *highz;
highz =(TH1D*) h14CB1->Clone("highz");//14-18 cm

   highz->Scale(ntrig14cb1/totalHighz);
 ...
 TH1D *h6to14;
   ...
   hn2to2 = (TH1D*)hn2CB1->Clone("hn2to2");
   hn2to2->Scale(ntrign2cb1/totaln2to2);
   h2to6 = (TH1D*)h2CB1->Clone("h2to6");
   h2to6->Scale(ntrig2cb1/total2to6);
   h6to14 =(TH1D*) h6CB1->Clone("h6to14");
   h6to14->Scale(ntrig6cb1/total6to14);
   h6to14->Add(h10CB1,ntrig10cb1/total6to14);
   h14to22 =(TH1D*) h14CB1->Clone("h14to22");
   h14to22->Scale(ntrig14cb1/total14to22);
   h14to22->Add(h18CB1,ntrig18cb1/total14to22);
   h22to30 = (TH1D*)h22CB1->Clone("h22to30");
   h22to30->Scale(ntrig22cb1/total22to30);
   h22to30->Add(h26CB1,ntrig26cb1/total22to30);
   hn22to30 =(TH1D*) hn30CB1->Clone("hn22to30");
   hn22to30->Scale(ntrign30cb1/totaln22to30);
   hn22to30->Add(hn26CB1,ntrign26cb1/totaln22to30);
   hn14to22 = (TH1D*)hn22CB1->Clone("hn14to22");
   hn14to22->Scale(ntrign22cb1/totaln14to22);
   hn14to22->Add(hn18CB1,ntrign18cb1/totaln14to22);
   hn6to14 =(TH1D*) hn14CB1->Clone("hn6to14");
   hn6to14->Scale(ntrign14cb1/totaln6to14);
   hn6to14->Add(hn10CB1,ntrign10cb1/totaln6to14);
   hn2to6 = (TH1D*)hn6CB1->Clone("hn2to6");
   hn2to6->Scale(ntrign6cb1/totaln2to6);
   ...
   float value = hNarrow->GetBinContent(hNarrow->FindBin(0));
   float valueerr = hNarrow->GetBinError(hNarrow->FindBin(0));
   cout<<"Max "<<value<<" +/- "<<valueerr<<" diff "<<total->GetMaximum()-hNarrow->GetMaximum()<<endl;
   ...
   if(write){
       canvasMany->SaveAs("comparisonManyStandardCB0to60.C");
   }
