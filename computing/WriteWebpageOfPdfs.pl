#!/usr/bin/perl
#Usage:  perl WriteWebpageOfPdfs.pl OutputFileName.html
system " ls *.pdf > listofps.txt";

unless($#ARGV==0){
print "Wrong number of parameters.  Usage:  perl WriteWebpageOfPdfs.pl OutputFileName.html";
die;
}
