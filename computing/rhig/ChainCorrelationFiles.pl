...
#This is for chaining together files which contain histograms.  It will not copy over TTrees properly.
#You need to change the
#1.  Input directory/output (roughly lines 10 & 12)
#2.  Macro name and location (roughly lines 19 & 100)
#to test without running comment out the line beginning with "system" at approximately line 100

#the command below should return the fiels which need to be chained together
@dir_array  = `ls /data3/nattrass/CuCu200/Correlations/partialChained/ridge*.root`;
#Below is the name of the file you would like to make
$outfile = "~nattrass/AzimuthalCorrelations/rootFiles/correlations_V0trigs_MB_Ridge.root";
$max_lines = $#dir_array; 
