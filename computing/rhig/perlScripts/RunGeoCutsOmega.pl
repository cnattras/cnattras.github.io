...
system "rm /data3/nattrass/CuCu200/geoCuts/omegacut*.root";

open (CONF, "</home/nattrass/AzimuthalCorrelations/textFiles/config-RunGeoCutsOmega.txt") || die "Can't open configuration file /home/nattrass/AzimuthalCorrelations/textFiles/config-RunGeoCutsOmega.txt.\n";
