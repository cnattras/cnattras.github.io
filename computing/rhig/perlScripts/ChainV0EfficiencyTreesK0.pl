...
#@dir_array  = `ls /data3/nattrass/CuCu200/V0EfficiencyTrees/FlatpTV0/K0Short/*.root`;
#$outfile = "~nattrass/AzimuthalCorrelations/rootFiles/V0Efficiencies/K0.root";
@dir_array  = `ls /data1/nattrass/CuCu62/V0Effieciency/root/*K0*.root`;
$outfile = "~nattrass/AzimuthalCorrelations/rootFiles/V0Efficiencies/CuCu62K0.root";
