...
system "rm /data1/nattrass/AuAu200Y7/QA/root/*.root";

open (CONF, "</home/nattrass/AzimuthalCorrelations/textFiles/config-RunQAMaker.txt") || die "Can't open configuration file /home/nattrass/AzimuthalCorrelations/textFiles/config-RunQAMaker.txt.\n";
...
$phiOutputFile = "$outputFile"."-phi";
$ptOutputFile = "$outputFile"."-pt";
...
if ($parameters>0) {
  ...
  #print OUTFILE "system \"root4star -q -b $macro\'('\\\"'\$inputFile[\$i]'\\\"','\\\"'/tmp/$phiOutputFile-$nameLine\$i.root'\\\"','\\\"'/tmp/$ptOutputFile-$nameLine\$i.root'\\\"','$textLine')\' >& /tmp/log-$nameLine-\$i.log\";\n";
  print OUTFILE "system \"root4star -q -b $macro\'(\\\"\$inputFile[\$i]\\\",\\\"/tmp/$phiOutputFile-$nameLine-\$i.root\\\",\\\"/tmp/$ptOutputFile-$nameLine-\$i.root\\\",$textLine)\' >& /tmp/log-$nameLine-\$i.log\";\n";
  ...
  print OUTFILE "system \"mv /tmp/$phiOutputFile-$nameLine-\$i.root $outputDir/.\";\n";
  print OUTFILE "system \"mv /tmp/$ptOutputFile-$nameLine-\$i.root $outputDir/.\";\n";
#  print OUTFILE "system \"mv /tmp/xi-$outputFile-$nameLine-\$i.root $outputDir/.\";\n";
  ...
  #print OUTFILE "system \"root4star -q -b $macro\'(''\\\"'\$inputFile[\$i]'\\\"','\\\"'/tmp/$phiOutputFile-$nameLine-\$i.root'\\\"'')\' >& /tmp/log-$nameLine-\$i.log\";\n";
  print OUTFILE "system \"root4star -q -b $macro\'(''\\\"'\$inputFile[\$i]'\\\"','\\\"'/tmp/$phiOutputFile-$nameLine-\$i.root'\\\"','\\\"'/tmp/$ptOutputFile-$nameLine-\$i.root'\\\"'')\' >& /tmp/log-$nameLine-\$i.log\";\n";
  print OUTFILE "system \"mv /tmp/$phiOutputFile-$nameLine-\$i.root $outputDir/.\";\n";
  print OUTFILE "system \"mv /tmp/$ptOutputFile-$nameLine-\$i.root $outputDir/.\";\n";
  #print OUTFILE "system \"mv /tmp/xi-$outputFile-$nameLine-\$i.root $outputDir/.\";\n";
  print OUTFILE "system \"mv /tmp/log-$nameLine-\$i.log $logFileDir/.\";\n";
