...
$inputDir = "/data1/nattrass/CuCu200P07ic/CuCu200WithSVT/rootMinBias";
$outputDir = "/data4/nattrass/CuCu200/TTreesMinBiasP07ic";
...
@dir_array = `cat ~/AzimuthalCorrelations/tmpfilelist.txt`;
