...
@dir_array  = `ls /data2/nattrass/CuCu200/Correlations/*high*$par1-$par2-*.root`;
$outfile = "~nattrass/AzimuthalCorrelations/rootFiles/correlations/correlations-HTMB-$par1-$par2-omegaCuts3.root";
