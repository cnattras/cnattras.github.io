...
$outfiledir = "/data2/nattrass/AuAu62/Correlations/partialChained";
@dir_array  = `ls /data2/nattrass/AuAu62/Correlations/correlation-track-merging-$par1-$par2-$par3-$par4-*.root`;
...
for ($i=0; $i <=$max_lines; $i++) # Loop through all lines
  {
    if ($i%$nFilesToChain==0) {
      ...
      $outfile = "$outfiledir/partialfiles-$par1-$par2-$par3-$par4-$id.root";
      open (OUTFILE, ">/home/nattrass/tmp/haddqa$id"."p"."$par1"."p"."$par2"."p"."$par3name"."p"."$par4name".".C");
      ...
      print OUTFILE "void haddqa$id"."p"."$par1"."p"."$par2"."p"."$par3name"."p"."$par4name"."() {\n";
...
for ($i=$firstFile; $i <$firstFile+$nFiles; $i++) # Loop through all lines
  {
    ...
    system "/usr/bin/ssh -l nattrass $host[$hostn] -q nice +10 root4star -b -q /home/nattrass/tmp/haddqa$i"."p"."$par1"."p"."$par2"."p"."$par3name"."p"."$par4name".".C >& /home/nattrass/tmp/haddqa$i-$par1-$par2-$par3-$par4.txt &\n";
