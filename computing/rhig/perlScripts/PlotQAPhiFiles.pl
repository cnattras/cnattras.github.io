#!/bin/perl
open (FILE, "<textFiles/AuAu200Y7PhiFileList.txt") || die "Can't oupen file with list of files.\n";
while (<FILE>)  # While still input lines in the file...
  {
    ...
    system "root4star -b -q macros/QA/PlotPhi.C\'(\"$data\",$j)\'\n";
    ($garb,$junk) = split("phi-AuAu200Y7",$data);
    ...
    print "mkdir Pics/QA/Phi/$folder\n";
    print "mv tmp/*.eps Pics/QA/Phi/$folder\n";
    system "mkdir Pics/QA/Phi/$folder\n";
    system "mv tmp/*.eps Pics/QA/Phi/$folder\n";
