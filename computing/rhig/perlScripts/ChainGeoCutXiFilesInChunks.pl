...
$outfiledir = "/data2/nattrass/CuCu200/geoCutsP06ib/partialChained";
@dir_array  = `ls /data2/nattrass/CuCu200/geoCutsP06ib/xicut-*.root`;
...
#$imaxhost=12;
@host = ("irhig02","irhig03","irhig04","irhig02","irhig03","irhig04");
$imaxhost=6;
