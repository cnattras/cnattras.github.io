...
$outfiledir = "/data2/nattrass/CuCu200/Correlations/partialChained";
@dir_array  = `ls /data2/nattrass/CuCu200/Correlations/correlation-highTower--$par1-$par2-*.root`;
...
#$imaxhost=$#host+1;
#$nFilesToChain = int($max_lines/$imaxhost);
$nFilesToChain = 15;
...
for ($i=0; $i <=$max_lines; $i++) # Loop through all lines
  {
    if ($i%$nFilesToChain==0) {
      ...
      $outfile = "$outfiledir/partialfiles-$par1-$par2-$id.root";
      open (OUTFILE, ">/home/nattrass/tmp/haddqa$id"."p"."$par1"."p"."$par2.C");
      ...
      print OUTFILE "void haddqa$id"."p"."$par1"."p"."$par2() {\n";
...
#only for 16 Oct 06
#$firstFile = 11;;
#@host = ("irhig01","irhig05","irhig05","irhig06","irhig06");
#$imaxhost = 5;
@host = ("irhig02","irhig03","irhig04","irhig07","irhig06","irhig05","irhig02","irhig03","irhig04","irhig07","irhig06","irhig05");
#@host = ("irhig02","irhig04","irhig05","irhig06","irhig07","irhig02","irhig04","irhig05","irhig06","irhig07");
$imaxhost=12;
for ($i=$firstFile; $i <$firstFile+$nFiles; $i++) # Loop through all lines
  {
    #print "Starting file $i\n";
    system "/usr/bin/ssh -l nattrass $host[$hostn] -q root4star -b -q /home/nattrass/tmp/haddqa$i"."p"."$par1"."p"."$par2.C >& /home/nattrass/tmp/haddqa$i-$par1-$par2.txt &\n";
    #system "root4star -b -q /home/nattrass/tmp/haddqa$i.C >& /home/nattrass/tmp/haddqa$i.txt";
