...
system "rm /data3/nattrass/CuCu200/geoCuts/-cut---*.root";

open (CONF, "</home/nattrass/AzimuthalCorrelations/textFiles/config-RunGeoCutsCuCu62.txt") || die "Can't open configuration file /home/nattrass/AzimuthalCorrelations/textFiles/config-RunGeoCuts62.txt.\n";
