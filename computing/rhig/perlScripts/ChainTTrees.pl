...
$inputDir = "/data1/nattrass/CuCu200P06ibSvtEmcSsd/rootMinBias";
$outputDir = "/data4/nattrass/CuCu200/TTreesMinBiasP06ibSvtEmcSsd";
...
#    print "root4star -b -q /tmp/hrootlambda$i.C";
  }
