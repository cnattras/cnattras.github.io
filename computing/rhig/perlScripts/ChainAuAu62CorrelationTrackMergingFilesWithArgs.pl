...
@dir_array  = `ls /data2/nattrass/AuAu62/Correlations/partialChained/partialfiles-$par1-$par2-$par3-$par4-*.root`;
$outfile = "~nattrass/AzimuthalCorrelations/rootFiles/correlations/correlations-AuAu62-$par1-$par2-$par3-$par4.root";
...
open (OUTFILE, ">/tmp/haddqa"."p"."$par1"."p"."$par2"."p"."$par3name"."p"."$par4name".".C");
...
print OUTFILE "void haddqa"."p"."$par1"."p"."$par2"."p"."$par3name"."p"."$par4name"."() {\n";
...
system "root4star -b -q /tmp/haddqa"."p"."$par1"."p"."$par2"."p"."$par3name"."p"."$par4name".".C";
