...
#@dir_array  = `ls /data2/nattrass/CuCu200/Correlations/partialChained/partialfiles-$par1-$par2-*.root`;
@dir_array = ("~nattrass/AzimuthalCorrelations/rootFiles/correlations/correlations-HTMB-$par1-$par2-omegaCuts3.root","~nattrass/AzimuthalCorrelations/rootFiles/correlations/correlations-$par1-$par2-omegaCuts3.root");
$outfile = "~nattrass/AzimuthalCorrelations/rootFiles/correlations/correlations-HTMBMB-combined-$par1-$par2-omegaCuts3.root";
...
open (OUTFILE, ">/tmp/haddqa"."p"."$par1"."p"."$par2".".C");
...
print OUTFILE "void haddqa"."p"."$par1"."p"."$par2"."() {\n";
...
system "root4star -b -q /tmp/haddqa"."p"."$par1"."p"."$par2".".C";
