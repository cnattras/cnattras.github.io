...
#@dir_array  = `ls /data3/nattrass/CuCu200/V0EfficiencyTrees/FlatpTV0/Lambda/*.root`;
#$outfile = "~nattrass/AzimuthalCorrelations/rootFiles/V0Efficiencies/Lambda.root";
@dir_array  = `ls /data1/nattrass/CuCu62/V0Effieciency/root/*Lambda*.root`;
$outfile = "~nattrass/AzimuthalCorrelations/rootFiles/V0Efficiencies/CuCu62Lambda.root";
...
print OUTFILE "TChain *chain1 = new TChain(\"assoc\")\;\n";
print OUTFILE "TChain *chain2 = new TChain(\"MC\")\;\n";
#print OUTFILE "TChain *chain3 = new TChain(\"Omega\")\;\n";
#print OUTFILE "TChain *chain4 = new TChain(\"AntiOmega\")\;\n";

for ($i=0; $i <=$max_lines; $i++) # Loop through all lines
{
    ($fname, $garb)  = split ("\n",$dir_array[$i]);
    print OUTFILE "chain1->Add(\"$fname\")\;\n";
    print OUTFILE "chain2->Add(\"$fname\")\;\n";
    #print OUTFILE "chain3->Add(\"$fname\")\;\n";
    #print OUTFILE "chain4->Add(\"$fname\")\;\n";
...
print OUTFILE "chain2->Merge(file,10000,\"keep\");\n";
#print OUTFILE "chain3->Merge(file,10000,\"keep\");\n";
#print OUTFILE "chain4->Merge(file,10000);\n";
print OUTFILE "\}\n";
print OUTFILE "void MergeRootfile( TDirectory *target, TList *sourcelist )\{\n";
