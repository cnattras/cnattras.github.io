...
system "rm /data1/nattrass/AuAu200Y7/geoCuts/-cut---*.root";

open (CONF, "</home/nattrass/AzimuthalCorrelations/textFiles/config-RunGeoCutsAuAu200.txt") || die "Can't open configuration file /home/nattrass/AzimuthalCorrelations/textFiles/config-RunGeoCutsAuAu200.txt.\n";
