...
@dir_array  = `ls /data2/nattrass/CuCu62/Correlations/partialChained/partialfiles-$par1-$par2-*.root`;
$outfile = "~nattrass/AzimuthalCorrelations/rootFiles/correlations/correlations-CuCu62-$par1-$par2.root";
