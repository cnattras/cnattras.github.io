...
open (CONF, "</home/nattrass/AzimuthalCorrelations/textFiles/config-RunPatch.txt") || die "Can't open configuration file /home/nattrass/AzimuthalCorrelations/textFiles/config-RunPatch.txt.\n";
...
#this line if you want to keep the output
  print OUTFILE "system \"root4star -q -b $macro\'(''\\\"'\$inputFile[\$i]'\\\"','\\\"'/tmp/$outputFile-$nameLine-\$i'\\\",'$textLine')\' >& /tmp/log-$nameLine-\$i.log\";\n";
#this line if you don't want the output because it's too much
  ...
  print OUTFILE "system \"mv /tmp/$outputFile-$nameLine-\$i* $outputDir/.\";\n";
...
#this line if you want to keep the output
  print OUTFILE "system \"root4star -q -b $macro\'(''\\\"'\$inputFile[\$i]'\\\"','\\\"'/tmp/$outputFile-$nameLine-\$i'\\\"'')\' >& /tmp/log-$nameLine-\$i.log\";\n";
