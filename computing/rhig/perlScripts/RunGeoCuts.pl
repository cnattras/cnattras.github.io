...
open (CONF, "</home/nattrass/AzimuthalCorrelations/textFiles/config-RunGeoCuts.txt") || die "Can't open configuration file /home/nattrass/AzimuthalCorrelations/textFiles/config-RunGeoCuts.txt.\n";
