...
@dir_array  = `ls /data2/nattrass/AuAu62/Correlations/partialChained/partialfiles-$par1-$par2-*.root`;
$outfile = "~nattrass/AzimuthalCorrelations/rootFiles/correlations/correlations-AuAu62-$par1-$par2.root";
