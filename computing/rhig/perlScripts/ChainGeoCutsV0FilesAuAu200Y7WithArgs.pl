...
@dir_array  = `ls /data1/nattrass/AuAu200Y7/geoCuts/*-$a-$b-$c-*.root`;
$outfile = "~nattrass/AzimuthalCorrelations/rootFiles/geoCuts/v0geoCutsAuAu200Y7-$a-$b-$c.root";
...
open (OUTFILE, ">/tmp/haddqa$a$b$c.C");
...
print OUTFILE "void haddqa$a$b$c() {\n";
...
system "root4star -b -q /tmp/haddqa$a$b$c.C";
