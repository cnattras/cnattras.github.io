...
@dir_array  = `ls /data3/nattrass/CuCu62/root/efficiency*.root`;
$outfile = "~nattrass/AzimuthalCorrelations/rootFiles/embeddingP06idCuCu62OutputPiMinusPlusCombined23July07.root";
...
system "root4star -b -q /tmp/haddef.C";
