...
@dir_array  = `ls /data3/nattrass/CuCu200/V0EfficiencyTrees/FlatpTV0/ALambda/*.root`;
$outfile = "~nattrass/AzimuthalCorrelations/rootFiles/V0Efficiencies/ALambda.root";
